...
@section('content')
    <div id="page-wrapper">
        <div class="main-page">
            <div class="tables">
                <h2 class="title1 col-md-4">{{ $stock->name }}/Add Product</h2>
                <div class="btn-create">
                    <button class="btn btn-success btn-add-category hidden" {{--data-toggle="modal" data-target="#update-stock-dialog"--}}>Add Category</button>
